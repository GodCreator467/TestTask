...
namespace Mathfp
{
    ...
    {
        private int _raw;
        private static readonly int Shift = 16;
        private static readonly int _PIMul2 = 0x6487E; // PI * 2.0f
        private static readonly int _RPIMul2 = 0x28BE; // 1.0f / (PI * 2.0f)

        public static readonly FixedPoint Float001 = new FixedPoint(0x28F);     // 0.01f
        public static readonly FixedPoint Float005 = new FixedPoint(0xCCD);     // 0.05f
        public static readonly FixedPoint Float01 = new FixedPoint(0x1999);     // 0.1f
        public static readonly FixedPoint Float02 = new FixedPoint(0x3333);     // 0.2f
        public static readonly FixedPoint Float025 = new FixedPoint(0x4000);    // 0.25f
        public static readonly FixedPoint Float03 = new FixedPoint(0x4CCC);     // 0.3f
        public static readonly FixedPoint Float05 = new FixedPoint(0x8000);     // 0.5f
        public static readonly FixedPoint Float075 = new FixedPoint(0xC000);    // 0.75f
        public static readonly FixedPoint Float15 = new FixedPoint(0x17FFE);    // 1.5f

        public static readonly FixedPoint Zero = new FixedPoint(0x0);
        public static readonly FixedPoint One = new FixedPoint(0x10000);

        public static readonly FixedPoint PI = new FixedPoint(0x3243F);
        public static readonly FixedPoint PI2 = new FixedPoint(_PIMul2);
        public static readonly FixedPoint PIDiv2 = new FixedPoint(0x1921F);
        public static readonly FixedPoint PIDiv4 = new FixedPoint(0xC90F);
        public static readonly FixedPoint PIDiv8 = new FixedPoint(0x6487);
        public static readonly FixedPoint PIDiv16 = new FixedPoint(0x3243);

        public static readonly FixedPoint Deg2Rad = new FixedPoint(0x477);
        public static readonly FixedPoint Rad2Deg = new FixedPoint(0x394BB8);

        public static FixedPoint Sqrt2 { get { return new FixedPoint(0x16A09); } }
        ...
        private static int Mul(int s1, int s2)
        {
            unchecked
            {
                return (int)(((long)s1 * s2) >> Shift);
            }
        }

        private static int Div(int s1, int s2)
        {
            unchecked
            {
                return s2 == 0 ? 0 : (int)(((long)s1 << Shift) / s2);
            }
        }

        private static int Rem(int s1, int s2)
        {
            unchecked
            {
                return (int)(((long)s1 << Shift) % s2);
            }
        }

        public FixedPoint Sin()
        {
            unchecked
            {
                int a = _raw;
                ...
                int raw = (a & 0x400) == 0 ? MathConst.SinTable[a & 0x3FF] : MathConst.SinTable[0x3FF - (a & 0x3FF)];
                raw = Mul(raw, 1 << Shift);
                if ((a & 0x800) != 0)
                {
                    raw = -raw;
        ...
        public static FixedPoint Asin(FixedPoint f)
        {
            return Atan2(f, ((FixedPoint.One + f) * (FixedPoint.One - f)).Sqrt());
        }

        public static FixedPoint Acos(FixedPoint f)
        {
            return Atan2(((FixedPoint.One + f) * (FixedPoint.One - f)).Sqrt(), f);
        }

        private static FixedPoint _Atan2C1 = new FixedPoint(0x163E); // 0.273 * M_1_PI
        private static FixedPoint _Atan2C2 = new FixedPoint(0x563F); // 0.25 + 0.273 * M_1_PI
        public static FixedPoint Atan2(FixedPoint y, FixedPoint x)
        {
            unchecked
            {
                FixedPoint result = Zero;
                if (y == x)
                {
                    if (y > 0)
                    { // 1/8
                ...
                {
                    FixedPoint nabs_y = FixedPoint.NAbs(y);
                    FixedPoint nabs_x = FixedPoint.NAbs(x);
                    if (nabs_x < nabs_y)
                    {
                        FixedPoint f = y / x;
                        FixedPoint c = _Atan2C1 * FixedPoint.NAbs(f);
                        FixedPoint u = (_Atan2C2 + c) * f;
                        if (x > 0)
                        {
                            result._raw = u._raw;
                        }
                    ...
                    else
                    {
                        ...
                        if (y > 0)
                        {
                            result._raw = 32768 - u._raw;
                        }
                        else
                        {
                            result._raw = 98304 - u._raw;
                        }
                    }
                }
                return result * FixedPoint.PI;
            }
        }

        public static FixedPoint operator -(FixedPoint v)
        {
            return new FixedPoint(-v._raw);
        }

        public static FixedPoint operator +(FixedPoint v1, FixedPoint v2)
        {
            return new FixedPoint(Add(v1._raw, v2._raw));
        }

        public static FixedPoint operator -(FixedPoint v1, FixedPoint v2)
        {
            return new FixedPoint(Sub(v1._raw, v2._raw));
        }

        public static FixedPoint operator *(FixedPoint v1, FixedPoint v2)
        {
            return new FixedPoint(Mul(v1._raw, v2._raw));
        }

        public static FixedPoint operator /(FixedPoint v1, FixedPoint v2)
        {
            return new FixedPoint(Div(v1._raw, v2._raw));
        }

        public static FixedPoint operator %(FixedPoint v1, FixedPoint v2)
        {
            return new FixedPoint(Rem(v1._raw, v2._raw));
        }
        ...
        public static FixedPoint operator >>(FixedPoint v, int shift)
        {
            return FromRaw(v._raw >> shift);
        }
        ...
        public int Ceil()
        {
            unchecked
            {
                return (_raw + 0xFFFF) >> Shift;
            }
        }

        public short Sign()
        {
            return (short)Math.Sign(_raw);
        }

        // Normalize to [0, 2 * PI)
        public static FixedPoint ConstrainAngle(FixedPoint a)
        {
            a._raw = a._raw % FixedPoint.PI2._raw;
            if (a < FixedPoint.Zero)
            {
                a += FixedPoint.PI2;
            }
            return a;
        ...
        public static FixedPoint AngleDiff(FixedPoint a, FixedPoint b)
        {
            FixedPoint dif;
            dif._raw = (b - a + FixedPoint.PI)._raw % FixedPoint.PI2._raw;
            if (dif < FixedPoint.Zero)
                dif += FixedPoint.PI2;
            return dif - FixedPoint.PI;
        }

        public static FixedPoint Max(FixedPoint f1, FixedPoint f2)
        {
            return FixedPoint.FromRaw(f2._raw & ((f1._raw - f2._raw) >> 31) | f1._raw & (~(f1._raw - f2._raw) >> 31));
        }

        public static FixedPoint Min(FixedPoint f1, FixedPoint f2)
        {
            return FixedPoint.FromRaw(f1._raw & ((f1._raw - f2._raw) >> 31) | f2._raw & (~(f1._raw - f2._raw) >> 31));
        }

        public static FixedPoint Abs(FixedPoint value)
        {
            return value._raw < 0 ? -value : value;
        }

        public static FixedPoint NAbs(FixedPoint value)
        {
            return value._raw > 0 ? -value : value;
        }
        ...
        public static bool IsSameSign(FixedPoint f1, FixedPoint f2)
        {
            return ((f1._raw >= 0) ^ (f2._raw < 0));
        }

        public static FixedPoint Sqr(FixedPoint f)
        {
            return f * f;
        }
        ...
        {
            return obj is FixedPoint && ((FixedPoint)obj)._raw == _raw;
        }
        ...
        {
            return string.Concat("Float: ", ToFloat().ToString(), ", FP: ", Raw.ToString());
        }

        public static implicit operator FixedPoint(short value)
        {
            return new FixedPoint(value << Shift);
        }

        public static explicit operator FixedPoint(ushort value)
        {
            return new FixedPoint(value << Shift);
        }

        public static explicit operator FixedPoint(int value)
        {
            return new FixedPoint(value << Shift);
        }
        ...
        {
            return new FixedPoint((int)(value * (1 << Shift)));
        }

        public byte ToByte()
        {
            return (byte)(_raw >> Shift);
        }

        public short ToShort()
        {
            return (short)(_raw >> Shift);
        }

        public ushort ToUShort()
        {
            return (ushort)(_raw >> Shift);
        }
        ...
        public uint ToUInt()
        {
            return (uint)_raw >> Shift;
        }

        public float ToFloat()
        {
            return (float)_raw / (1 << Shift);
        }

        public static FixedPoint FromRaw(int value)
        {
    ...
    static class MathConst
    {
        ...
        public static UInt16[] SinTable = new UInt16[] {
